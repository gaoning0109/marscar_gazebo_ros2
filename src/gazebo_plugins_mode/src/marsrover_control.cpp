...
void GazeboRosAckermannDrive::Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  impl_->joints_[GazeboRosAckermannDrivePrivate::MIDDLE_RIGHT] = _model->GetJoint(middle_right_joint);
  if (!impl_->joints_[GazeboRosAckermannDrivePrivate::MIDDLE_RIGHT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->joints_[GazeboRosAckermannDrivePrivate::MIDDLE_LEFT] = _model->GetJoint(middle_left_joint);
  if (!impl_->joints_[GazeboRosAckermannDrivePrivate::MIDDLE_LEFT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->joints_[GazeboRosAckermannDrivePrivate::STEER_REAR_RIGHT] =
    _model->GetJoint(right_rear_steering_joint);
  if (!impl_->joints_[GazeboRosAckermannDrivePrivate::STEER_REAR_RIGHT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->joints_[GazeboRosAckermannDrivePrivate::STEER_REAR_LEFT] =
    _model->GetJoint(left_rear_steering_joint);
  if (!impl_->joints_[GazeboRosAckermannDrivePrivate::STEER_REAR_LEFT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
...
void GazeboRosAckermannDrivePrivate::OnUpdate(const gazebo::common::UpdateInfo & _info)
{
  ...
  joints_[STEER_REAR_RIGHT]->SetForce(0, -right_steering_cmd);
  joints_[STEER_REAR_LEFT]->SetForce(0, -left_steering_cmd);
  joints_[FRONT_LEFT]->SetForce(0, linear_cmd);
  joints_[FRONT_RIGHT]->SetForce(0, linear_cmd);
  joints_[MIDDLE_LEFT]->SetForce(0, linear_cmd);
  joints_[MIDDLE_RIGHT]->SetForce(0, linear_cmd);
