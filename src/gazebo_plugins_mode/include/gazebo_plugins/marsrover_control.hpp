...
/**
  ...
  \code{.xml}
    <plugin name="gazebo_ros_ackermann_drive" filename="libgazebo_ros_ackermann_drive.so">
      ...
      <middle_left_joint>middle_left_wheel_joint</middle_left_joint>
      <middle_right_joint>middle_right_wheel_joint</middle_right_joint>
      <left_steering_joint>front_left_steer_joint</left_steering_joint>
      <right_steering_joint>front_right_steer_joint</right_steering_joint>
      <left_rear_steering_joint>rear_left_steer_joint</left_rear_steering_joint>
      <right_rear_steering_joint>rear_right_steer_joint</right_rear_steering_joint>
